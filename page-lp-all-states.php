...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* Hero */
  .hero{background:linear-gradient(180deg, rgba(106,44,145,.08), rgba(106,44,145,0) 60%), radial-gradient(1200px 600px at 85% -20%, rgba(244,123,32,.08), transparent 60%); min-height: 50vh; padding-top: 5rem; padding-bottom: 2rem;}
