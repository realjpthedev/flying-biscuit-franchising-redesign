...
<section class="reasons">
  <div class="reasons__inner">
    ...
    <div class="reasons__header">
      <p class="reasons__eyebrow">Why Flying Biscuit</p>
      <h2 class="reasons__title">Reasons To Own A Flying Biscuit Franchise</h2>
    </div>
    ...
    <div class="reasons__grid">
      ...
      <div class="reasons__card">
        <h3 class="reasons__card-title">$2 Million *</h3>
        <p class="reasons__card-desc">System-Wide Average Sales</p>
      </div>

      <div class="reasons__card">
        <h3 class="reasons__card-title">Home By 3pm</h3>
        <p class="reasons__card-desc">Work–life balance built into every shift</p>
      </div>

      <div class="reasons__card">
        <h3 class="reasons__card-title">Cult Following</h3>
        <p class="reasons__card-desc">30 years of creating raving fans across America</p>
      </div>
      ...
      <div class="reasons__card">
        <h3 class="reasons__card-title">30 Year Track Record</h3>
        <p class="reasons__card-desc">Own a brand with the power to last</p>
      </div>
    ...
    <!-- Disclaimer -->
    <div class="reasons__disclaimer">
      <button
        class="reasons__disclaimer-toggle"
        id="reasonsDisclaimerToggle"
        type="button"
        aria-expanded="false"
        aria-controls="reasonsDisclaimerBody"
      >
        <span class="reasons__disclaimer-toggle-text">* Legal Disclaimers &amp; FDD Details</span>
        <span class="reasons__disclaimer-toggle-arrow" aria-hidden="true"></span>
      </button>
      <div
        class="reasons__disclaimer-body"
        id="reasonsDisclaimerBody"
        role="region"
        aria-labelledby="reasonsDisclaimerToggle"
      >
        <div class="reasons__disclaimer-content">
          ...
          <p>Growth year after year' refers to historical franchise growth, including system-wide revenue and/or unit expansion over the past 6 years. Results may vary, and past performance does not guarantee future success.</p>
        </div>
      </div>
    </div>
